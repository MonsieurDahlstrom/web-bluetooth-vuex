...
var CharacteristicActions = {
  webBluetoothDiscoverCharacteristics: function () {
    var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(_ref, query) {
      ...
      var discoveredCharacteristics, characteristics, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, characteristic, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, _service, _service2;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              for (_iterator = (0, _getIterator3.default)(characteristics); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                dispatch('webBluetoothConfigureCharacteristic', { service: query.service, characteristic: characteristic });
                discoveredCharacteristics.push(service);
              }
              _context.next = 16;
              break;
            ...
            case 31:
              ...
              _context.next = 35;
              return query.device.getPrimaryService(_service2);

            case 35:
              _service2 = _context.sent;

              dispatch('webBluetoothConfigureCharacteristic', { service: query.service, characteristic: characteristic });
              discoveredCharacteristics.push(_service2);
            ...
            case 55:
              commit(MutationTypes.BLE_CHARACTERISTICS_ADDED, { characteristics: discoverCharacteristics });
      ...
      return _regenerator2.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              commit(MutationTypes.BLE_CHARACTERISTIC_CHANGED, { services: discoveredServices });
